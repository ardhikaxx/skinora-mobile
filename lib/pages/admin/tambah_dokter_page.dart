...
class TambahDokterPage extends StatefulWidget {
  ...
  @override
  State<TambahDokterPage> createState() => _TambahDokterPageState();
}

class _TambahDokterPageState extends State<TambahDokterPage> {
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // SPESIALISASI *
                        _buildLabel('SPESIALISASI', isRequired: true),
                        const SizedBox(height: 8),
