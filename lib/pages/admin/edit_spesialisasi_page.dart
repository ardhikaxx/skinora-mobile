...
class EditSpesialisasiPage extends StatefulWidget {
  final String initialName;
  final ValueChanged<int>? onNavigateTab;

  const EditSpesialisasiPage({
    super.key,
  ...
  @override
  State<EditSpesialisasiPage> createState() => _EditSpesialisasiPageState();
}

class _EditSpesialisasiPageState extends State<EditSpesialisasiPage> {
